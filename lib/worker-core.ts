...
import {Wallet as WalletImpl, initSpectreFramework} from '@spectre/wallet';
import {TxSend, TxInfo} from '@spectre/wallet/types/custom-types';
...
export class WorkerCore extends EventEmitter{
	...
	async init(){
		...
		super.init();
		workerLog.debug("before initSpectreFramework")
		await initSpectreFramework();
		workerLog.debug("after initSpectreFramework")
