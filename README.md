...
## Cloning spectre-wallet-worker

```
git clone https://github.com/spectre-project/spectre-wallet-worker
cd spectre-wallet-worker
npm install
```
...
* `amount` - Amount of SPR in base units
